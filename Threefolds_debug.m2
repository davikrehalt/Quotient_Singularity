...
getT1 = (R, ggenerators) -> (
  print("=== Starting getT1 ===");
  N = #ggenerators;
  dimension = #ggenerators#0;
  print("N: ", N, " dimension: ", dimension);
  ...
  for d from 0 to dimension - 1 do (
    ...
    if #E1#d > 0 then (
      ...
      print("ECoordinateDiag: ", ECoordinateDiag);
      print("ECoordinates: ", ECoordinates);
    );
  );

  -- Compute E2 and SecondDifferential
  print("=== Computing E2 and SecondDifferential ===");
